...
(function(scope) {
    $('#nest_' + scope.$id).ready(function() {
        nest = new thermostatDial(document.getElementById('nest_' + scope.$id),{
    ...
    function nest(config) {
        ...
        try {
            ...
            var done = ui.addWidget({
                ...
                // beforeEmit: function (value) {
                //     node.log("convertBack: " + value);
                //     return value + "Y";
                // },
        ...
        node.on('input', function(msg) {
            // node.log("Received 1: " + msg.payload);
